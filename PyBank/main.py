...
with open(output_path, 'w', newline='') as csvoutputfile:
    ...
    csvwriter.writerow(["Greatest Increase in Profits:",greatest_increase_amt," ", greatest_increase_month])
    csvwriter.writerow(["Greatest Decrease in Profits:",greatest_decrease_amt," ", greatest_decrease_month])
    csvwriter.writerow(["--------------------------------------------------------"])
